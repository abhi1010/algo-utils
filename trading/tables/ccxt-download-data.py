...
def parse_args():
  ...
  parser.add_argument(
      ...
      default='1d',
      choices=[
          '1m', '5m', '15m', '30m', '1h', '2h', '3h', '4h', '6h', '12h', '1d',
          '1M', '1y'
      ],
      help='The timeframe to download')

  parser.add_argument(
      '--debug', action='store_true', help=('Print Sizer Debugs'))
...
if exchange.has["fetchOHLCV"] != True:
  ...
  print(
      ...
      .format(args.exchange))
  print('-' * 80)
  quit()

# Check requested timeframe is available. If not return a helpful error.
if (not hasattr(exchange, 'timeframes')) or (args.timeframe
...
filename = 'data/ccxt/{}-{}-{}.csv'.format(
    args.exchange, symbol_out, args.timeframe)
